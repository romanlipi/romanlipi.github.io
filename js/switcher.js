...
jQuery(document).ready(function($) {
	...
	if (enable_switcher) {
		...
		$switcher.find('#colors li a').click(function() {
			...
			setCookie("color_scheme", colorName, expiry.toGMTString(), "http://e-merald.com/");
		...
		$switcher.find('#image-background li a').click(function() {
			...
			var expiry = new Date();
			expiry.setTime(expiry.getTime() + 30*60*1000);
			setCookie("body_bg_class", bodyBgClassName, expiry.toGMTString(), "http://e-merald.com/");
			setCookie("body_bg_type", 'image-background', expiry.toGMTString(), "http://e-merald.com/");
		...
		$switcher.find('#pattern-background li a').click(function() {
			...
			expiry.setTime(expiry.getTime() + 30*60*1000);
			setCookie("body_bg_class", bodyBgClassName, expiry.toGMTString(), "http://e-merald.com/");
			setCookie("body_bg_type", 'pattern-background', expiry.toGMTString(), "http://e-merald.com/");
		...
		$switcher.find('#reset').click(function() {
			...
			deleteCookie("color_scheme", "http://e-merald.com/");
			...
			deleteCookie("body_bg_class", "http://e-merald.com/");
			deleteCookie("body_bg_type", "http://e-merald.com/");
